...
def parse_args():
    ...
    parser.add_argument('--detector', type=str, default='bayes', choices=['bayes', 'minimax', 'neyman-pearson'])
    parser.add_argument('--output_dir', type=str, default='', help='Directory where model and logs are saved')
    parser.add_argument('--skew_task_distribution', action='store_true', default=False, help='If skewed, set(T_train) & set(T_eval) = {}')
