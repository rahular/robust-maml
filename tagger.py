...
from utils import BaseTransformer, add_generic_args, generic_train
from data_utils import convert_examples_to_features, get_labels, read_examples_from_file
...
class POSTransformer(BaseTransformer):
    ...
    def __init__(self, hparams):
        self.labels = get_labels(hparams.data_dir)
